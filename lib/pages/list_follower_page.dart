...
class ListFollowerPage extends StatelessWidget {
  const ListFollowerPage({Key? key}) : super(key: key);
              ...
              children: [
                ...
                Flexible(
                  child: Padding(
                    ...
                    child: createBody(x, x.itemHome.value.followers!),
                  ),
                ),
              ],
            ),
  ...
  Widget createBody(final XController x, final List<FollowModel> followers) {
